...
import com.example.bookstore.dao.DiscountDao;
...
public class DiscountServiceImpl implements DiscountService {
	...
	public User sendCodeDiscount(Integer discountId, User user) {
		...
		mailerService.queue(user.getEmail(), "Smart Library. Thông Tin Khuyến Mãi!", 
				"Xin chào bạn " + user.getFullname() +",<br>"
				+ "Smart Library xin thông báo đến bạn chương trình. " + discount.getName() + " khi bạn nhập mã <b>" + discount.getCode() + "</b>." + "<br>"
